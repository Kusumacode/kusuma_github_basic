package Assignments_1to100; //WAP on updating global static and non static variable

public class Assign17_GlobalVarUpdating 
{
	static int sub1=90;
	static int sub2=92;
	static int sub3=88;
	...
	public static void main(String[] args) 
	{
		...
		sub2();
		sub3();
		Assign17_GlobalVarUpdating gv=new Assign17_GlobalVarUpdating();
		gv.sub4();
		gv.sub5();
		gv.sub6();
	}
